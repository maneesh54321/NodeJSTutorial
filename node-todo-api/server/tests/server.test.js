...
describe('GET /todos/:id', () => {
    it('should return todo doc', (done) => {
        request(app)
            ...
            .expect(200)
            .expect((res) => {
                expect(res.body.todo).toMatchObject({ text: 'First test todo' });
            })
            .end(done);
    });
...
describe('POST /users', () => {
    ...
    it('should not create if email already taken', (done) => {
        request(app)
            .post('/users')
            .send({
                email: users[0].email, //email already taken
                password: 'test123'
            })
            .expect(400)
            .end(done);
...
describe('POST /users/login',()=>{
    ...
    it('shoud reject invalid login',(done)=>{
        request(app)
            .post('/users/login')
            .send({
                email:'users[1].email',
